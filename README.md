...
Welcome to my GitHub profile! I'm a Data Scientist and former Master Teacher with over a decade of experience at the intersection of education, policy, and data science. 🎓📊

## About Me

I pronounce "Chrzan" as "chr" like chirp and "zen" like the state of mind. 
...
- Repos related to fun side projects, like my Heart-of-the-Cards repo where I play around with some Yu-Gi-Oh! data

## Tools & Technologies I Love

R, Python, SQL, PyTorch, Pandas, Tidyverse, PostgreSQL, deep learning frameworks, and statistical modeling techniques such as linear regression, IRT, and causal inference.
...
- I've been honored with awards including the Dean’s Fellowship at Stanford and scholarships like the Gates Millennium Scholarship and Coca-Cola Scholars. 

## Let's Connect!

Feel free to explore my repositories, where I share research projects, educational tools, and code that bridges data science and education as well as fun side projects. 
Whether you're an educator, researcher, policymaker, or fellow data enthusiast, I hope my work inspires and empowers you! 

Reach out anytime via my [LinkedIn](https://www.linkedin.com/in/mlchrzan/). 
